...
<head>
  ...
  background-image: url("images/add_books.png");
...
<div id="main">
  <span style="font-size:30px;cursor:pointer; color: black;font-family: Lucida Handwriting" onclick="openNav() ">&#9776; Menu</span>
  <div class="container" style="text-align: center;">
    <h2 style="color:black; font-family: Cursive; text-align: center; font-size:35px"><b>Add New Books</b></h2>
