...
<div class="container" style="color:Black;">
	...
	<h3 style="text-align: center; font-size:40px; color:Black;">Request of Book</h3>
	...
	if(isset($_SESSION['login_user']))
	{
		...
		{
			echo "<table class='table table-bordered' style='font-size: 17px'>";
			echo "<tr style='background-color: LightSalmon; color:Black'>";
				//Table header
